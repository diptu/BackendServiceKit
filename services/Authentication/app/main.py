...
Verifies identity only — never makes an authorization decision (that's
IAM's ABAC policy-evaluation engine, and this service never even imports
IAM's code). Owns exactly four tables: credentials, refresh_tokens,
password_reset_tokens, auth_events. Never stores anything else — no
profile fields, no permissions, no roles.
"""
