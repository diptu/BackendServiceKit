...
class Settings(BaseSettings):
    ...
    # Application
    app_name: str = "nutratenant-session-management"
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5433/nutratenant_session",
    )
    ...
    # Session policy
    session_ttl_seconds: int = 86_400  # 24h default session lifetime
    session_refresh_extends_seconds: int = 86_400  # refresh extends by this much
