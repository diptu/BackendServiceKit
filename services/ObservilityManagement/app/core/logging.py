...
copied verbatim from the established pattern used by every merged service.
"""
...
class _FallbackJSONFormatter(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        payload: dict[str, Any] = {
            ...
            "logger": record.name,
            "service": "observability-management",
...
def configure_logging(*, debug: bool = False) -> None:
    try:
        ...
        _configure(debug=debug, service_name="observability-management")
        return
    except ImportError:
        pass
