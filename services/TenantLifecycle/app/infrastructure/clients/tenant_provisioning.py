...
TenantLifecycle is authoritative; TP unavailability does not block the state transition.
"""
...
class TenantProvisioningClient:
    ...
    async def start_provisioning(self, tenant_id: UUID) -> None:
        """Notify TenantProvisioning to start the provisioning workflow for this tenant.
