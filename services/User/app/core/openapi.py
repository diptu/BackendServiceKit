...
TAGS_METADATA: list[dict[str, Any]] = [
    {
        "name": "Users",
        "description": (
            "Identity CRUD, status lifecycle (pending → active ⇄ suspended "
            "⇄ locked → deactivated), and restore. Every request is scoped "
    ...
    },
    {
        ...
        "description": (
            ...
            "avatar, contact info. Does not store first_name/last_name — "
            "that stays on the User record."
        ),
    },
    {
        "name": "Health",
...
R_409: dict[str, Any] = {
    "description": "Conflict — duplicate email, invalid status transition, or user is not deleted.",
