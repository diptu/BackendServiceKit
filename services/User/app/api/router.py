...
from app.api.v1.invitations_router import router as invitations_router
from app.api.v1.profiles_router import router as profiles_router
...
_v1.include_router(profiles_router)
