"""Platform Invitation endpoints — onboards a brand-new person onto the
platform (accepting one creates a User row). Distinct from
OrganizationManagement's own invitations, which add an already-known
user_id to a specific organization with a role.
"""
