...
class Settings(BaseSettings):
    ...
    # Application
    app_name: str = "nutratenant-organization-management"
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5433/nutratenant_organization",
    )
